...
Assets =
{
    ...
    Asset("ANIM", "anim/ui_medalcontainer_upgraded_2x6.zip"),
    Asset("ANIM", "anim/ui_medalcontainer_upgraded_2x8.zip"),
    Asset("ANIM", "anim/ui_medalcontainer_upgraded_5x10.zip"),
...
AddMinimapAtlas("minimap/medal_shroom_chest.xml")
